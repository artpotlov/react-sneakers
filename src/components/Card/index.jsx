...
function Card({ val }) {
  ...
  const { isLoadingGoods, addToFav, addToCart, cartItems, favItems } =
        ...
        <>
          <button className={styles.favoriteBtn} onClick={() => addToFav(val)}>
            <img
              src={
                inFavorite(val)
                  ? "/assets/icons/favorite-card.svg"
                  : "/assets/icons/unfavorite-card.svg"
              }
              alt={
                inFavorite(val)
          ...
          <div className={styles.information}>
            <div className={styles.informationPriceBlock}>
              ...
              <span className={styles.informationPriceBlockTotal}>
                {price} руб.
              </span>
            </div>
            <button
              className={styles.informationAddBtn}
